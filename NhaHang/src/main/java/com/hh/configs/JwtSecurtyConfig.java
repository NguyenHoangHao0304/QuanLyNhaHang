 ...
 */
package com.hh.configs;

import com.hh.filters.CustomAccessDeniedHandler;
import com.hh.filters.JwtAuthenticationTokenFilter;
import com.hh.filters.RestAuthenticationEntryPoint;
...
//        http.csrf().disable();
        ...
        http.authorizeRequests().antMatchers("/api/hallprices/**").permitAll();
...
//        http.authorizeRequests().antMatchers(HttpMethod.GET, "/api/current-user/").permitAll();
