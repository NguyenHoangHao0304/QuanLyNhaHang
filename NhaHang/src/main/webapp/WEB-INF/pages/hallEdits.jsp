...
<c:url value="/hallEdits" var="action" />
<form:form modelAttribute="hallEdit" method="post" action="${action}" enctype="multipart/form-data">
    ...
    <div class="form-floating mb-3 mt-3">
        ...
        <label for="description">Sức Chứa</label>
    ...
    <div class="form-floating mb-3 mt-3">
        ...
        <label for="price">Giá Buổi Sáng</label>
    ...
    <div class="form-floating mb-3 mt-3">
        ...
        <label for="price">Giá Buổi Trưa</label>
    ...
    <div class="form-floating mb-3 mt-3">
        ...
        <label for="price">Giá Buổi Tối</label>
    ...
    <div class="form-floating mb-3 mt-3">
        ...
        <label for="price">Giá Cuối Tuần</label>
    ...
    <div class="form-floating">
        <form:select class="form-select" id="branch" name="branch" path="branchId">
            <c:forEach items="${branchs}" var="b">
                <c:choose>
                    <c:when test="${b.id==hallEdit.branchId.id}">
